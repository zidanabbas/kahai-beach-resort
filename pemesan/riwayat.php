            ...
            <div id="content">
                ...
                <div class="container-fluid" style="min-height: 450px;">
                    ...
                    <div class="container-fluid py-3">
                        ...
                        $sql_cek = mysqli_query($conn, "SELECT MAX(id_pemesanan) as id_pemesanan, MAX(kode_pemesanan) as maxID FROM pemesanan WHERE username = '$user' ");
                        $data_cek = mysqli_fetch_assoc($sql_cek);

                        // AMBIL DATA SESUAI ID YANG SUDAH DI CEK
                        $sql = mysqli_query($conn, "SELECT * FROM pemesanan WHERE id_pemesanan = '$data_cek[id_pemesanan]' ORDER BY id_pemesanan ASC ");
                                            ...
                                            <div class="col-md-5">
                                                <ul>
                                                    ...
                                                    <li><span>Status Pesanan :
                                                            ...
                                                            //     echo '<span class="btn btn-sm btn-success px-3" style="cursor: auto;">Check In</span>';
                                                            ...
                                                            //     echo '<span class="btn btn-sm btn-danger" style="cursor: auto;">Check Out</span>';
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Zidane Abbas 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
